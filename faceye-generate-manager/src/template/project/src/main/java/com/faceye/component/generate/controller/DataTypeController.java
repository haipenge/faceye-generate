...
@Controller
@Scope("prototype")
@RequestMapping("/generate/dataType")
public class DataTypeController extends BaseController<DataType, Long, DataTypeService> {
	...
	public String home(HttpServletRequest request, Model model) {
		...
		return "generate.dataType.manager";
	}
	...
	public String edit(@PathVariable("id") Long id,Model model,HttpServletRequest request) {
		...
		return "generate.dataType.update";
	}
	 ...
	 */
	@RequestMapping("/save")
	public String save(DataType entity, RedirectAttributes redirectAttributes) {
		this.service.save(entity);
		return "redirect:/generate/dataType/home";
	}
	...
	public String detail(@PathVariable Long id,Model model){
		...
		return "generate.dataType.detail";
	}
