...
public class ${entity.className}Controller extends BaseController<${entity.className}, Long, ${entity.className}Service> {
	...
	public String home(HttpServletRequest request, Model model) {
		...
		return "${component.packageName}.${entity.className?uncap_first}.mobile.home";
	}
	...
	public String edit(@PathVariable("id") Long id,Model model,HttpServletRequest request) {
		...
		model.addAttribute("global",global);
		return "${component.packageName}.${entity.className?uncap_first}.mobile.update";
	}
	...
	public String detail(@PathVariable Long id,Model model){
		...
		return "${component.packageName}.${entity.className?uncap_first}.mobile.detail";
	}
	///////////////////////////////////////////////以下为回调函数///////////////////////////////////////////////
