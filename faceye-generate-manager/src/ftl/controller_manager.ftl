...
public class ${entity.className}Controller extends BaseController<${entity.className}, Long, ${entity.className}Service> {
	...
	public String edit(@PathVariable("id") Long id,Model model,HttpServletRequest request) {
		if(id!=null){
			...
			beforeInput(${entity.className?uncap_first},model,request);
	 ...
	 * 创建日期:${.now}<br>
	 */
	protected void beforeInput(${entity.className} ${entity.className?uncap_first},Model model,HttpServletRequest request){
		<#list properties as property>
		  <#if property.referenceEntity?? >
          ...
          <#if property.inputTypeText=="radio" || property.inputTypeText=="checkbox" || property.inputTypeText=="select">
            Pairs<String,String> ${property.propertyName}s=${property.propertyName?cap_first}.${property.propertyName}s;
		    model.addAttribute("${property.propertyName}s", ${property.propertyName}s.getPairs());
          </#if>
		</#list>
	}
