...
<div class="page-head">
	<h2>
		...
		<a class="btn btn-primary" href="<c:url value="/generate/project/input"/>"> <fmt:message key="generate.project.add"></fmt:message>
		</a>
	</h2>
</div>
			...
			<form action="<c:url value="/generate/project/home"/>" method="post" role="form" class="form-horizontal">
				<fieldset>
					<div class="form-group">
						<div class="col-md-2">
							<input type="text" name="LIKE|name" value="${searchParams.name}" placeholder="<fmt:message key="generate.project.name"></fmt:message>" class="form-control input-sm">
						</div>
						<div class="col-md-2">
							<input type="text" name="EQ|packageName" value="${searchParams.packageName}" placeholder="<fmt:message key="generate.project.packageName"></fmt:message>"
								class="form-control input-sm">
						</div>
						<div class="col-md-2">
							<input type="text" name="EQ|author" value="${searchParams.author}" placeholder="<fmt:message key="generate.project.author"></fmt:message>" class="form-control input-sm">
						</div>
