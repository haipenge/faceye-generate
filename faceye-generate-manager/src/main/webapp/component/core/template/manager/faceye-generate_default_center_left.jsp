...
<li><a href="#"><i class="fa fa-file"></i><span><fmt:message key="generate.manager" /></span></a>
	<ul class="sub-menu">
		<li class="<%=JspUtil.isActive(request, "generate")%>"><a href="/generate/project/home"><fmt:message key="generate.project.manager"></fmt:message></a></li>
